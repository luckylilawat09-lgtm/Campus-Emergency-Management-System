...
Displays the emergency reports.
Creates several campus resources.
Checks whether selected resources are suitable for particular emergencies.
Assigns an available ambulance to a medical emergency.
Updates the emergency status to ASSIGNED.
Prints the resulting resource and emergency information.
